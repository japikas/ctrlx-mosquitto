...
> [!IMPORTANT]
> Mosquitto does not reload changed configurations automatically, but only when starting. Thus, configuration changes must be applied via application Disable - Enable cycle.
